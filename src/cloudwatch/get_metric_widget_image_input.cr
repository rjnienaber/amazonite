module Amazonite::CloudWatch
  class GetMetricWidgetImageInput
    ...
    #
    # For more information about the syntax of `MetricWidget` see [GetMetricWidgetImage: Metric Widget
    # Structure and
    ...
    # content-type set to `text/xml`. The image data is in a `MetricWidgetImage` field. For example:
    #
    # ` >`
    #
    # ` `
    ...
    # actions using an Amazon Web Services SDK, you should use `png`. If you specify `image/png`, the
    # HTTP response has a content-type set to `image/png`, and the body of the response is a PNG
    # image.
