...
module Amazonite::CloudWatch
  ...
  class CreateResourceMetricsConfigurationInput
    ...
    # The Amazon Resource Name (ARN) of the Amazon Web Services resource to enable detailed monitoring
    # for.
    @[JSON::Field(key: "ResourceArn")]
    property resource_arn : String

    # Specifies which metrics Amazon CloudWatch collects for the resource. If you omit this parameter,
