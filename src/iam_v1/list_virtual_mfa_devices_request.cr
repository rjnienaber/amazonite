...
module Amazonite::IamV1
  class ListVirtualMFADevicesRequest
    ...
    # `AssignmentStatus`, the operation defaults to `Any`, which lists both assigned and unassigned
    # virtual MFA devices.,
    property assignment_status : AssignmentStatusType | Nil
    ...
    def initialize(
      @assignment_status : AssignmentStatusType | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      if value = @assignment_status
        params << {"#{prefix}AssignmentStatus", value.to_json_object_key}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        assignment_status: (n = node.xpath_node("*[local-name()='AssignmentStatus']")) ? AI::AssignmentStatusType.from_json_object_key?(n.content) : nil,
    ...
    def_equals_and_hash(@assignment_status, @marker, @max_items)
  end
end
