...
module Amazonite::IamV1
  class ListServerCertificateTagsResponse
    # The list of tags that are currently attached to the IAM server certificate. Each tag consists of
    # a key name and an associated value. If no tags are attached to the specified resource, the
    ...
    def_equals_and_hash(@tags, @is_truncated, @marker)
  end
end
