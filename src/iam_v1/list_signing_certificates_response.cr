...
module Amazonite::IamV1
  ...
  class ListSigningCertificatesResponse
    ...
    property certificates : Array(SigningCertificate) = [] of SigningCertificate
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      @certificates.each_with_index(1) do |item, i|
        params.concat(item.to_query_params("#{prefix}Certificates.member.#{i}."))
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        certificates: node.xpath_nodes("*[local-name()='Certificates']/*[local-name()='member']").map { |n| SigningCertificate.from_xml(n) },
    ...
    def_equals_and_hash(@certificates, @is_truncated, @marker)
  end
end
