...
module Amazonite::IamV1
  class ListInstanceProfileTagsResponse
    # The list of tags that are currently attached to the IAM instance profile. Each tag consists of a
    # key name and an associated value. If no tags are attached to the specified resource, the
