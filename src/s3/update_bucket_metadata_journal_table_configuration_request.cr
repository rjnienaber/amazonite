...
module Amazonite::S3
  class UpdateBucketMetadataJournalTableConfigurationRequest
    ...
    property journal_table_configuration : JournalTableConfigurationUpdates
    ...
    def_equals_and_hash(@bucket, @content_md5, @checksum_algorithm, @journal_table_configuration, @expected_bucket_owner)
  end
end
