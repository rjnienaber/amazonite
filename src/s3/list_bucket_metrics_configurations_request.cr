module Amazonite::S3
  class ListBucketMetricsConfigurationsRequest
    ...
    # the `NextContinuationToken` from a previously truncated list response to continue the listing.
    ...
    def_equals_and_hash(@bucket, @continuation_token, @expected_bucket_owner)
  end
end
