...
module Amazonite::S3
  ...
  class Checksum
    ...
    # The Base64 encoded, 64-bit `CRC64NVME` checksum of the object. This checksum is present if the
    # object was uploaded with the `CRC64NVME` checksum algorithm, or if the object was uploaded
    # without a checksum (and Amazon S3 added the default checksum, `CRC64NVME`, to the uploaded
    # object). For more information, see [Checking object
    ...
    # The Base64 encoded, 512-bit `SHA512` digest of the object. This checksum is present if the
    # object was uploaded with the `SHA512` checksum algorithm. For more information, see [Checking
    # object
    # integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html)
    # in the *Amazon S3 User Guide*.
    property checksum_sha512 : String | Nil

    # The Base64 encoded, 128-bit `MD5` digest of the object. This checksum is present if the object
    # was uploaded with the `MD5` checksum algorithm. For more information, see [Checking object
    # integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html)
    # in the *Amazon S3 User Guide*.
    property checksum_md5 : String | Nil

    # The Base64 encoded, 64-bit `XXHASH64` checksum of the object. This checksum is present if the
    ...
    # The Base64 encoded, 64-bit `XXHASH3` checksum of the object. This checksum is present if the
    ...
    # The Base64 encoded, 128-bit `XXHASH128` checksum of the object. This checksum is present if the
    ...
    def_equals_and_hash(@checksum_crc32, @checksum_crc32c, @checksum_crc64nvme, @checksum_sha1, @checksum_sha256, @checksum_sha512, @checksum_md5, @checksum_xxhash64, @checksum_xxhash3, @checksum_xxhash128, @checksum_type)
  end
end
