...
module Amazonite::S3
  class GetBucketLifecycleConfigurationOutput
    ...
    property rules : Array(LifecycleRule) | Nil
    ...
    def initialize(
      @rules : Array(LifecycleRule) | Nil = nil,
    ...
    def build_xml(xml : XML::Builder) : Nil
      (@rules || [] of LifecycleRule).each do |item|
    ...
    def_equals_and_hash(@rules, @transition_default_minimum_object_size)
  end
end
