...
module Amazonite::S3
  class PutBucketRequestPaymentRequest
    ...
    # Container for Payer.
    property request_payment_configuration : RequestPaymentConfiguration
    ...
    def validate! : Nil
      if value = @request_payment_configuration
        value.validate!
      end
    end

    def_equals_and_hash(@bucket, @content_md5, @checksum_algorithm, @request_payment_configuration, @expected_bucket_owner)
  end
end
