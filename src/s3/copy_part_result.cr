...
module Amazonite::S3
  ...
  class CopyPartResult
    ...
    # The Base64 encoded, 160-bit `SHA1` digest of the part. This checksum is present if the multipart
    # upload request was created with the `SHA1` checksum algorithm. For more information, see
    # [Checking object
    # integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html)
    # in the *Amazon S3 User Guide*.
    ...
    def_equals_and_hash(@e_tag, @last_modified, @checksum_crc32, @checksum_crc32c, @checksum_crc64nvme, @checksum_sha1, @checksum_sha256, @checksum_sha512, @checksum_md5, @checksum_xxhash64, @checksum_xxhash3, @checksum_xxhash128)
  end
end
