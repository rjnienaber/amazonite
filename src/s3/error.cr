...
module Amazonite::S3
  # For information about using the Amazon S3 API—including error handling—see the [Amazon S3
  # Developer Guide](https://docs.aws.amazon.com/AmazonS3/latest/developerguide/Welcome.html).
  #
  ...
  class Error
    ...
    # Amazon S3 error codes. For more information, see [Error
    ...
    # - *Code:* AccountProblem
    #
    # - *Description:* There is a problem with your Amazon Web Services account that prevents the
    ...
    #
    # - *Description:* All access to this Amazon S3 resource has been disabled. Contact Amazon Web
    ...
    #
    # - *Description:* The requested bucket name is not available. The bucket namespace is shared by
    ...
    # Regions, see [How to Select a Region for Your
    ...
    #
    # - *Description:* The list of parts was not in ascending order. Parts list must be specified in
    ...
    # - *Code:* InvalidPayer
    #
    # - *Description:* All access to this object has been disabled. Please contact Amazon Web Services
    ...
    # - *Code:* InvalidRequest
    #
    # - *Description:* Amazon S3 Transfer Acceleration is not supported on this bucket. Contact Amazon
    ...
    # published XSD) for the configuration. The error message is, "The XML you provided was not
    ...
    # - *Code:* NoSuchVersion
    #
    # - *Description:* Indicates that the version ID specified in the request does not match an
    # existing version.
    #
    # - *HTTP Status Code:* 404 Not Found
    #
    ...
    # before you can use Amazon S3. You can sign up at the following URL: [Amazon
    ...
    # Check your Amazon Web Services secret access key and signing method. For more information, see
    # [REST Authentication](https://docs.aws.amazon.com/AmazonS3/latest/dev/RESTAuthentication.html)
    # and [SOAP
    # Authentication](https://docs.aws.amazon.com/AmazonS3/latest/dev/SOAPAuthentication.html) for
    # details.
    #
    # - *HTTP Status Code:* 403 Forbidden
    #
    ...
    #
    # - *Description:* The bucket POST must contain the specified field name. If it is specified,
    ...
    # intended for a human audience. Simple programs display the message directly to the end user if
    # they encounter an error condition they don't know how or don't care to handle. Sophisticated
    # programs with more exhaustive error handling and proper internationalization are more likely to
    ...
    def build_xml(xml : XML::Builder) : Nil
      ...
      if value = @code
        xml.element("Code") { xml.text value }
      end

      if value = @message
        xml.element("Message") { xml.text value }
      end
    end
    ...
    def_equals_and_hash(@key, @version_id, @code, @message)
  end
end
