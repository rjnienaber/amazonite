...
module Amazonite::S3
  ...
  class Part
    ...
    # The Base64 encoded, 32-bit `CRC32` checksum of the part. This checksum is present if the object
    # was uploaded with the `CRC32` checksum algorithm. For more information, see [Checking object
    ...
    # was uploaded with the `CRC32C` checksum algorithm. For more information, see [Checking object
    # integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html)
    # in the *Amazon S3 User Guide*.
    ...
    # The Base64 encoded, 160-bit `SHA1` checksum of the part. This checksum is present if the object
    # was uploaded with the `SHA1` checksum algorithm. For more information, see [Checking object
    # integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html)
    # in the *Amazon S3 User Guide*.
    ...
    def_equals_and_hash(@part_number, @last_modified, @e_tag, @size, @checksum_crc32, @checksum_crc32c, @checksum_crc64nvme, @checksum_sha1, @checksum_sha256, @checksum_sha512, @checksum_md5, @checksum_xxhash64, @checksum_xxhash3, @checksum_xxhash128)
  end
end
