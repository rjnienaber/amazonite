...
module Amazonite::S3
  class PutBucketLoggingRequest
    ...
    property bucket_logging_status : BucketLoggingStatus
    ...
    def validate! : Nil
      if value = @bucket_logging_status
        value.validate!
      end
    end

    def_equals_and_hash(@bucket, @bucket_logging_status, @content_md5, @checksum_algorithm, @expected_bucket_owner)
  end
end
