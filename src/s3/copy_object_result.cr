...
module Amazonite::S3
  ...
  class CopyObjectResult
    ...
    # The Base64 encoded, 512-bit `SHA512` digest of the object. This checksum is only present if the
    ...
    # The Base64 encoded, 128-bit `MD5` digest of the object. This checksum is only present if the
    # object was uploaded with the `MD5` checksum algorithm. For more information, see [Checking
    # object
    # integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html)
    # in the *Amazon S3 User Guide*.
    property checksum_md5 : String | Nil

    # The Base64 encoded, 64-bit `XXHASH64` checksum of the object. This checksum is only present if
    ...
    # The Base64 encoded, 64-bit `XXHASH3` checksum of the object. This checksum is only present if
    ...
    # The Base64 encoded, 128-bit `XXHASH128` checksum of the object. This checksum is only present if
    ...
    def_equals_and_hash(@e_tag, @last_modified, @checksum_type, @checksum_crc32, @checksum_crc32c, @checksum_crc64nvme, @checksum_sha1, @checksum_sha256, @checksum_sha512, @checksum_md5, @checksum_xxhash64, @checksum_xxhash3, @checksum_xxhash128)
  end
end
