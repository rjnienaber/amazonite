...
module Amazonite::DynamoDBV2
  ...
  class GlobalTableGlobalSecondaryIndexSettingsUpdate
    ...
    def validate! : Nil
      ...
      if value = @provisioned_write_capacity_auto_scaling_settings_update
        value.validate!
      end
    end

    def_equals_and_hash(@index_name, @provisioned_write_capacity_units, @provisioned_write_capacity_auto_scaling_settings_update)
  end
end
