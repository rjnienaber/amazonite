module Amazonite::DynamoDBV2
  ...
  class BatchWriteItemOutput
    ...
    # directly to a subsequent `BatchWriteItem` operation. For more information, see `RequestItems` in
    ...
    # all of the local secondary indexes on the table. Use this estimate to measure whether a local
