...
module Amazonite::DynamoDBV2
  ...
  class PutItemOutput
    ...
    # The attribute values as they appeared before the `PutItem` operation, but only if `ReturnValues`
    # is specified as `ALL_OLD` in the request. Each element consists of an attribute name and an
    # attribute value.
