...
module Amazonite::DynamoDBV2
  ...
  class BatchGetItemInput
    ...
    # A map of one or more table names or table ARNs and, for each table, a map that describes one or
    # more items to retrieve from that table. Each table name or ARN can be used only once per
    ...
    # table. These attributes can include scalars, sets, or elements of a JSON document. The
