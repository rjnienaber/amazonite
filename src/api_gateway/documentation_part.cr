...
module Amazonite::ApiGateway
  ...
  class DocumentationPart
    ...
    property location : DocumentationPartLocation | Nil
    ...
    # OpenAPI-compliant documentation-related fields from the properties map are exported and, hence,
    ...
    property properties : String | Nil
