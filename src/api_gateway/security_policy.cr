  ...
  enum SecurityPolicy
    ...
    def self.to_json(e : SecurityPolicy, json : JSON::Builder) : Nil
      value = case e
              ...
              when AAG::SecurityPolicy::SecurityPolicyTls1312Ext2Pq202509     then "SecurityPolicy_TLS13_1_2_Ext2_PQ_2025_09"
              when AAG::SecurityPolicy::SecurityPolicyTls1312Ext2FipsPq202509 then "SecurityPolicy_TLS13_1_2_Ext2_FIPS_PQ_2025_09"
    ...
    def self.from_json(pull : JSON::PullParser) : AAG::SecurityPolicy
      ...
      when "SecurityPolicy_TLS13_1_2_Ext2_PQ_2025_09"      then AAG::SecurityPolicy::SecurityPolicyTls1312Ext2Pq202509
      when "SecurityPolicy_TLS13_1_2_Ext2_FIPS_PQ_2025_09" then AAG::SecurityPolicy::SecurityPolicyTls1312Ext2FipsPq202509
