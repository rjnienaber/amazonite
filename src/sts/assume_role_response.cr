...
module Amazonite::Sts
  ...
  class AssumeRoleResponse
    ...
    # based on the value of source identity. For more information about using source identity, see
    ...
    def_equals_and_hash(@credentials, @assumed_role_user, @packed_policy_size, @source_identity, @session_token_utilization, @session_token_size)
  end
end
