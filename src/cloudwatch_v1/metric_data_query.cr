module Amazonite::CloudWatchV1
  ...
  class MetricDataQuery
    ...
    # [Metrics Insights query components and
    ...
    # data values of this metric. If you are performing this call just to do math expressions and do
    # not also need the raw data returned, you can specify `false`. If you omit this, the default of
    # `true` is used.
    #
    # When used in `PutMetricAlarm`, specify `true` for the one expression result to use as the alarm.
    # For all other metrics and expressions in the same `PutMetricAlarm` operation, specify
    # `ReturnData` as False.
