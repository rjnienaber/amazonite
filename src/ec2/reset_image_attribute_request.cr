...
module Amazonite::EC2
  ...
  class ResetImageAttributeRequest
    ...
    property attribute : ResetImageAttributeName
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        attribute: ((n = node.xpath_node("*[local-name()='Attribute']")) ? AEC::ResetImageAttributeName.from_json_object_key?(n.content) : nil).not_nil!,
