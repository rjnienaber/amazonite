...
module Amazonite::EC2
  ...
  class SecondaryNetworkIpv4CidrBlockAssociation
    ...
    property state : SecondaryNetworkCidrBlockAssociationState | Nil
    ...
    def initialize(
      ...
      @state : SecondaryNetworkCidrBlockAssociationState | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        state: (n = node.xpath_node("*[local-name()='state']")) ? AEC::SecondaryNetworkCidrBlockAssociationState.from_json_object_key?(n.content) : nil,
