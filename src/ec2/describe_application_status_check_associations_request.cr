...
module Amazonite::EC2
  class DescribeApplicationStatusCheckAssociationsRequest
    # The IDs of the application status checks for which to describe associations.
    property application_status_check_ids : Array(String) | Nil
    ...
    def initialize(
      @application_status_check_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@application_status_check_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}ApplicationStatusCheckId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        application_status_check_ids: node.xpath_nodes("*[local-name()='ApplicationStatusCheckId']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@application_status_check_ids, @filters, @max_results, @next_token, @dry_run)
  end
end
