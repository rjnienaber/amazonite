...
module Amazonite::EC2
  class DescribeVpcBlockPublicAccessExclusionsRequest
    ...
    #
    # - `internet-gateway-exclusion-mode` - The mode of a VPC BPA exclusion. Possible values:
    # `allow-bidirectional | allow-egress`.
    #
    # - `state` - The state of VPC BPA. Possible values: `create-in-progress | create-complete |
    ...
    # resources assigned a tag with a specific value, regardless of the tag key.
    property filters : Array(Filter) | Nil

    # IDs of exclusions.
    property exclusion_ids : Array(String) | Nil
    ...
    def initialize(
      ...
      @exclusion_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@exclusion_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}ExclusionId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        exclusion_ids: node.xpath_nodes("*[local-name()='ExclusionId']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@dry_run, @filters, @exclusion_ids, @next_token, @max_results)
  end
end
