...
module Amazonite::EC2
  class DescribeIpamPoolsRequest
    ...
    property ipam_pool_ids : Array(String) | Nil
    ...
    def initialize(
      ...
      @ipam_pool_ids : Array(String) | Nil = nil,
    )
    end
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@ipam_pool_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}IpamPoolId.#{i}", item}
      end
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        ipam_pool_ids: node.xpath_nodes("*[local-name()='IpamPoolId']/*[local-name()='item']").map { |n| n.content },
      )
    end
    ...
    def_equals_and_hash(@dry_run, @filters, @max_results, @next_token, @ipam_pool_ids)
  end
end
