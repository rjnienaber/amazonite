...
module Amazonite::EC2
  class GetCoipPoolUsageRequest
    ...
    #
    # - `coip-address-usage.aws-account-id` - The ID of the Amazon Web Services account that is using
    ...
    def_equals_and_hash(@pool_id, @filters, @max_results, @next_token, @dry_run)
  end
end
