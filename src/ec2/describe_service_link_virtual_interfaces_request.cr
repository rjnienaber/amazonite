  ...
  class DescribeServiceLinkVirtualInterfacesRequest
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@service_link_virtual_interface_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}ServiceLinkVirtualInterfaceId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        service_link_virtual_interface_ids: node.xpath_nodes("*[local-name()='ServiceLinkVirtualInterfaceId']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@service_link_virtual_interface_ids, @filters, @max_results, @next_token, @dry_run)
  end
end
