...
module Amazonite::EC2
  ...
  class TransitGatewayPropagation
    ...
    def_equals_and_hash(@transit_gateway_attachment_id, @resource_id, @resource_type, @transit_gateway_route_table_id, @state, @transit_gateway_route_table_announcement_id)
  end
end
