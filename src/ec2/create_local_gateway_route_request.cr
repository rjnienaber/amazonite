...
module Amazonite::EC2
  class CreateLocalGatewayRouteRequest
    ...
    def_equals_and_hash(@destination_cidr_block, @local_gateway_route_table_id, @local_gateway_virtual_interface_group_id, @dry_run, @network_interface_id, @destination_prefix_list_id)
  end
end
