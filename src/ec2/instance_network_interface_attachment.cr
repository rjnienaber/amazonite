...
module Amazonite::EC2
  ...
  class InstanceNetworkInterfaceAttachment
    ...
    property ena_srd_specification : InstanceAttachmentEnaSrdSpecification | Nil
    ...
    def initialize(
      ...
      @ena_srd_specification : InstanceAttachmentEnaSrdSpecification | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        ena_srd_specification: node.xpath_node("*[local-name()='enaSrdSpecification']").try { |n| InstanceAttachmentEnaSrdSpecification.from_xml(n) },
    ...
    def_equals_and_hash(@attach_time, @attachment_id, @delete_on_termination, @device_index, @status, @network_card_index, @ena_srd_specification, @ena_queue_count)
  end
end
