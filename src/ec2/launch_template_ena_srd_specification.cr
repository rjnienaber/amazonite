...
module Amazonite::EC2
  ...
  class LaunchTemplateEnaSrdSpecification
    ...
    property ena_srd_udp_specification : LaunchTemplateEnaSrdUdpSpecification | Nil

    def initialize(
      @ena_srd_enabled : Bool | Nil = nil,
      @ena_srd_udp_specification : LaunchTemplateEnaSrdUdpSpecification | Nil = nil,
    )
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        ena_srd_udp_specification: node.xpath_node("*[local-name()='enaSrdUdpSpecification']").try { |n| LaunchTemplateEnaSrdUdpSpecification.from_xml(n) },
      )
    end
