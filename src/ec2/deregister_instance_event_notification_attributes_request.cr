...
module Amazonite::EC2
  class DeregisterInstanceEventNotificationAttributesRequest
    ...
    property instance_tag_attribute : DeregisterInstanceTagAttributeRequest
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        instance_tag_attribute: node.xpath_node("*[local-name()='InstanceTagAttribute']").try { |n| DeregisterInstanceTagAttributeRequest.from_xml(n) }.not_nil!,
      )
    end
