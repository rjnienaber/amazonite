...
module Amazonite::EC2
  ...
  class ClientVpnRouteStatus
    ...
    property code : ClientVpnRouteStatusCode | Nil

    # A message about the status of the Client VPN endpoint route, if applicable.
    property message : String | Nil

    def initialize(
      @code : ClientVpnRouteStatusCode | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        code: (n = node.xpath_node("*[local-name()='code']")) ? AEC::ClientVpnRouteStatusCode.from_json_object_key?(n.content) : nil,
