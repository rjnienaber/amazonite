...
module Amazonite::EC2
  ...
  class CancelSpotFleetRequestsError
    # The error code.
    property code : CancelBatchErrorCode | Nil

    # The description for the error code.
    property message : String | Nil

    def initialize(
      @code : CancelBatchErrorCode | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        code: (n = node.xpath_node("*[local-name()='code']")) ? AEC::CancelBatchErrorCode.from_json_object_key?(n.content) : nil,
