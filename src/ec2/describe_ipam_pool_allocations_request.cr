...
module Amazonite::EC2
  class DescribeIpamPoolAllocationsRequest
    ...
    property ipam_pool_allocation_ids : Array(String) | Nil
    ...
    def initialize(
      ...
      @ipam_pool_allocation_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@ipam_pool_allocation_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}IpamPoolAllocationId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        ipam_pool_allocation_ids: node.xpath_nodes("*[local-name()='IpamPoolAllocationId']/*[local-name()='item']").map { |n| n.content },
    ...
    def validate! : Nil
      ...
      if value = @max_results
        ...
        raise Core::ValidationError.new("MaxResults value must be <= 100000") if value > 100000
      end
    end

    def_equals_and_hash(@dry_run, @ipam_pool_allocation_ids, @filters, @max_results, @next_token)
  end
end
