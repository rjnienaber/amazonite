...
module Amazonite::EC2
  class DescribeSecondarySubnetsRequest
    ...
    #
    # - `state` - The state of the secondary subnet (`create-in-progress` | `create-complete` |
    ...
    property secondary_subnet_ids : Array(String) | Nil
    ...
    def initialize(
      ...
      @secondary_subnet_ids : Array(String) | Nil = nil,
    )
    end
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@secondary_subnet_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}SecondarySubnetId.#{i}", item}
      end
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        secondary_subnet_ids: node.xpath_nodes("*[local-name()='SecondarySubnetId']/*[local-name()='item']").map { |n| n.content },
      )
    end
    ...
    def_equals_and_hash(@dry_run, @filters, @max_results, @next_token, @secondary_subnet_ids)
  end
end
