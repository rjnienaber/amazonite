...
module Amazonite::EC2
  class DescribeVolumeAttributeRequest
    ...
    property attribute : VolumeAttributeName
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        attribute: ((n = node.xpath_node("*[local-name()='Attribute']")) ? AEC::VolumeAttributeName.from_json_object_key?(n.content) : nil).not_nil!,
    ...
    def_equals_and_hash(@attribute, @volume_id, @dry_run)
  end
end
