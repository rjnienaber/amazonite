...
module Amazonite::EC2
  class GetIpamDiscoveredPublicAddressesRequest
    ...
    property address_region : String
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      params << {"#{prefix}AddressRegion", @address_region}
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        address_region: Core::XMLValue.string(node.xpath_node("*[local-name()='AddressRegion']")).not_nil!,
    ...
    def_equals_and_hash(@dry_run, @ipam_resource_discovery_id, @address_region, @filters, @next_token, @max_results)
  end
end
