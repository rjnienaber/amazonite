...
module Amazonite::EC2
  ...
  class LaunchTemplateInstanceMarketOptionsRequest
    ...
    property spot_options : LaunchTemplateSpotMarketOptionsRequest | Nil

    def initialize(
      @market_type : MarketType | Nil = nil,
      @spot_options : LaunchTemplateSpotMarketOptionsRequest | Nil = nil,
    )
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        spot_options: node.xpath_node("*[local-name()='SpotOptions']").try { |n| LaunchTemplateSpotMarketOptionsRequest.from_xml(n) },
      )
    end
