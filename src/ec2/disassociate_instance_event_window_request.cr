...
module Amazonite::EC2
  class DisassociateInstanceEventWindowRequest
    ...
    property association_target : InstanceEventWindowDisassociationRequest
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      params.concat(@association_target.to_query_params("#{prefix}AssociationTarget."))
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        association_target: node.xpath_node("*[local-name()='AssociationTarget']").try { |n| InstanceEventWindowDisassociationRequest.from_xml(n) }.not_nil!,
      )
    end
    ...
    def_equals_and_hash(@dry_run, @instance_event_window_id, @association_target)
  end
end
