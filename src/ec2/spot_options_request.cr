...
module Amazonite::EC2
  ...
  class SpotOptionsRequest
    ...
    # interrupted.
    property maintenance_strategies : FleetSpotMaintenanceStrategiesRequest | Nil
    ...
    # Spot `AllocationStrategy` is set to `lowest-price`. EC2 Fleet selects the cheapest Spot pools
    ...
    def initialize(
      ...
      @maintenance_strategies : FleetSpotMaintenanceStrategiesRequest | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        maintenance_strategies: node.xpath_node("*[local-name()='MaintenanceStrategies']").try { |n| FleetSpotMaintenanceStrategiesRequest.from_xml(n) },
