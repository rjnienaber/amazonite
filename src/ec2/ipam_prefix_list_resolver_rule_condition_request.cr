...
module Amazonite::EC2
  ...
  class IpamPrefixListResolverRuleConditionRequest
    ...
    property operation : IpamPrefixListResolverRuleConditionOperation
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      params << {"#{prefix}Operation", @operation.to_json_object_key}
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        operation: ((n = node.xpath_node("*[local-name()='Operation']")) ? AEC::IpamPrefixListResolverRuleConditionOperation.from_json_object_key?(n.content) : nil).not_nil!,
