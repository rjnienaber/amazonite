...
module Amazonite::EC2
  class DescribeDhcpOptionsRequest
    ...
    property dhcp_options_ids : Array(String) | Nil
    ...
    def initialize(
      @dhcp_options_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@dhcp_options_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}DhcpOptionsId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        dhcp_options_ids: node.xpath_nodes("*[local-name()='DhcpOptionsId']/*[local-name()='DhcpOptionsId']").map { |n| n.content },
    ...
    def_equals_and_hash(@dhcp_options_ids, @next_token, @max_results, @dry_run, @filters)
  end
end
