...
module Amazonite::EC2
  class DescribeIpamScopesRequest
    ...
    property ipam_scope_ids : Array(String) | Nil
    ...
    def initialize(
      ...
      @ipam_scope_ids : Array(String) | Nil = nil,
    )
    end
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@ipam_scope_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}IpamScopeId.#{i}", item}
      end
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        ipam_scope_ids: node.xpath_nodes("*[local-name()='IpamScopeId']/*[local-name()='item']").map { |n| n.content },
      )
    end
    ...
    def_equals_and_hash(@dry_run, @filters, @max_results, @next_token, @ipam_scope_ids)
  end
end
