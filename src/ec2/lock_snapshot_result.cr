...
module Amazonite::EC2
  class LockSnapshotResult
    ...
    def_equals_and_hash(@snapshot_id, @lock_state, @lock_duration, @cool_off_period, @cool_off_period_expires_on, @lock_created_on, @lock_expires_on, @lock_duration_start_time)
  end
end
