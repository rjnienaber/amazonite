...
module Amazonite::EC2
  class CreateSecondaryNetworkRequest
    ...
    property network_type : SecondaryNetworkType
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      params << {"#{prefix}NetworkType", @network_type.to_json_object_key}
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        network_type: ((n = node.xpath_node("*[local-name()='NetworkType']")) ? AEC::SecondaryNetworkType.from_json_object_key?(n.content) : nil).not_nil!,
    ...
    def_equals_and_hash(@client_token, @dry_run, @ipv_4_cidr_block, @network_type, @tag_specifications)
  end
end
