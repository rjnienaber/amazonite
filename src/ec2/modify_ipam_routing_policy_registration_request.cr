...
module Amazonite::EC2
  class ModifyIpamRoutingPolicyRegistrationRequest
    ...
    # Specifies whether to permit more specific route announcements than the CIDR prefix. Default:
    # `false`.
    property permit_more_specific_announcements : Bool | Nil

    # The new maximum prefix length that the ASNs are authorized to announce. Must be greater than or
    # equal to the prefix length of the CIDR.
