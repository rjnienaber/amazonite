...
module Amazonite::EC2
  ...
  class FleetSpotCapacityRebalance
    ...
    #
    # `launch` - EC2 Fleet launches a new replacement Spot Instance when a rebalance notification is
    ...
    #
    # `launch-before-terminate` - EC2 Fleet launches a new replacement Spot Instance when a rebalance
