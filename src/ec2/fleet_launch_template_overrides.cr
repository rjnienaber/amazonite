...
module Amazonite::EC2
  ...
  class FleetLaunchTemplateOverrides
    ...
    # If no number is set, the override has the lowest priority. You can set the same priority for
    # different launch template overrides.
    property priority : Float64 | Nil

    # The location where the instance launched, if applicable.
    property placement : PlacementResponse | Nil
    ...
    # in the *Amazon EC2 User Guide*.
    property block_device_mappings : Array(BlockDeviceMappingResponse) | Nil
    ...
    def initialize(
      ...
      @placement : PlacementResponse | Nil = nil,
      @instance_requirements : InstanceRequirements | Nil = nil,
      @image_id : String | Nil = nil,
      @block_device_mappings : Array(BlockDeviceMappingResponse) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@block_device_mappings || [] of BlockDeviceMappingResponse).each_with_index(1) do |item, i|
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        placement: node.xpath_node("*[local-name()='placement']").try { |n| PlacementResponse.from_xml(n) },
        ...
        block_device_mappings: node.xpath_nodes("*[local-name()='blockDeviceMappingSet']/*[local-name()='item']").map { |n| BlockDeviceMappingResponse.from_xml(n) },
    ...
    def_equals_and_hash(@instance_type, @max_price, @subnet_id, @availability_zone, @weighted_capacity, @priority, @placement, @instance_requirements, @image_id, @block_device_mappings, @availability_zone_id)
  end
end
