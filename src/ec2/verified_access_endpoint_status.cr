...
module Amazonite::EC2
  ...
  class VerifiedAccessEndpointStatus
    ...
    property code : VerifiedAccessEndpointStatusCode | Nil

    # The status message of the Verified Access endpoint.
    property message : String | Nil

    def initialize(
      @code : VerifiedAccessEndpointStatusCode | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        code: (n = node.xpath_node("*[local-name()='code']")) ? AEC::VerifiedAccessEndpointStatusCode.from_json_object_key?(n.content) : nil,
