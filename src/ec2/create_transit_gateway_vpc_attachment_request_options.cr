...
module Amazonite::EC2
  ...
  class CreateTransitGatewayVpcAttachmentRequestOptions
    ...
    #
    # This option is set to `enable` by default. However, at the transit gateway level the default is
    # set to `disable`.
    #
    # For more information about security group referencing, see [Security group referencing
    ...
    # traffic. The default is `disable`.
