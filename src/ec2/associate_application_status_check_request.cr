...
module Amazonite::EC2
  class AssociateApplicationStatusCheckRequest
    # The ID of the application status check to associate.
    property application_status_check_id : String

    # The [tags](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html) to associate the
    # application status check with. Each tag is a key-value pair. When you associate tags, the
    # application status check automatically monitors all instances that have the specified tags.
