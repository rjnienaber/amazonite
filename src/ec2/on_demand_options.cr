...
module Amazonite::EC2
  ...
  class OnDemandOptions
    ...
    property capacity_reservation_options : CapacityReservationOptions | Nil
    ...
    def initialize(
      ...
      @capacity_reservation_options : CapacityReservationOptions | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        capacity_reservation_options: node.xpath_node("*[local-name()='capacityReservationOptions']").try { |n| CapacityReservationOptions.from_xml(n) },
