...
module Amazonite::EC2
  ...
  class ImageUsageResourceType
    ...
    # `ec2:LaunchTemplate`.
    property resource_type_options : Array(ImageUsageResourceTypeOption) | Nil

    def initialize(
      @resource_type : String | Nil = nil,
      @resource_type_options : Array(ImageUsageResourceTypeOption) | Nil = nil,
    )
    end
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@resource_type_options || [] of ImageUsageResourceTypeOption).each_with_index(1) do |item, i|
        params.concat(item.to_query_params("#{prefix}ResourceTypeOptionSet.#{i}."))
      end
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        resource_type_options: node.xpath_nodes("*[local-name()='resourceTypeOptionSet']/*[local-name()='item']").map { |n| ImageUsageResourceTypeOption.from_xml(n) },
      )
    end
