...
module Amazonite::EC2
  class GetGroupsForCapacityReservationRequest
    # The ID of the Capacity Reservation. If you specify a Capacity Reservation that is shared with
    # you, the operation returns only Capacity Reservation groups that you own.
    ...
    def_equals_and_hash(@capacity_reservation_id, @next_token, @max_results, @dry_run)
  end
end
