...
module Amazonite::EC2
  class UpdateSecurityGroupRuleDescriptionsIngressRequest
    ...
    # the security group name. For security groups in a nondefault VPC, you must specify the security
    # group ID.
    ...
    # The description for the ingress security group rules. You must specify either a description or
    # IP permissions.
