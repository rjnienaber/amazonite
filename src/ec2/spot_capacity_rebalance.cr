...
module Amazonite::EC2
  ...
  class SpotCapacityRebalance
    ...
    # notification.
    property replacement_strategy : ReplacementStrategy | Nil
    ...
    def initialize(
      @replacement_strategy : ReplacementStrategy | Nil = nil,
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        replacement_strategy: (n = node.xpath_node("*[local-name()='replacementStrategy']")) ? AEC::ReplacementStrategy.from_json_object_key?(n.content) : nil,
