...
module Amazonite::EC2
  class DescribeApplicationStatusRequest
    ...
    #
    # - `status` – The instance-level application status. For valid values and their meanings, see
    # `ApplicationStatus`.
    ...
    def_equals_and_hash(@instance_ids, @filters, @max_results, @next_token, @dry_run)
  end
end
