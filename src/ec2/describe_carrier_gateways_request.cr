...
module Amazonite::EC2
  class DescribeCarrierGatewaysRequest
    ...
    property carrier_gateway_ids : Array(String) | Nil
    ...
    def initialize(
      @carrier_gateway_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@carrier_gateway_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}CarrierGatewayId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        carrier_gateway_ids: node.xpath_nodes("*[local-name()='CarrierGatewayId']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@carrier_gateway_ids, @filters, @max_results, @next_token, @dry_run)
  end
end
