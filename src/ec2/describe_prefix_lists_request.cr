  ...
  class DescribePrefixListsRequest
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@prefix_list_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}PrefixListId.#{i}", item}
      end
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        prefix_list_ids: node.xpath_nodes("*[local-name()='PrefixListId']/*[local-name()='item']").map { |n| n.content },
      )
    end
    ...
    def_equals_and_hash(@dry_run, @filters, @max_results, @next_token, @prefix_list_ids)
  end
end
