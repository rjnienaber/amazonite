...
module Amazonite::EC2
  class DescribeVpcAttributeRequest
    # The VPC attribute.
    property attribute : VpcAttributeName
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        attribute: ((n = node.xpath_node("*[local-name()='Attribute']")) ? AEC::VpcAttributeName.from_json_object_key?(n.content) : nil).not_nil!,
    ...
    def_equals_and_hash(@attribute, @vpc_id, @dry_run)
  end
end
