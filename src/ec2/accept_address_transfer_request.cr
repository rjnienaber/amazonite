...
module Amazonite::EC2
  class AcceptAddressTransferRequest
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        address: Core::XMLValue.string(node.xpath_node("*[local-name()='Address']")).not_nil!,
    ...
    def_equals_and_hash(@address, @tag_specifications, @dry_run)
  end
end
