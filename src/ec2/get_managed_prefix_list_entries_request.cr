...
module Amazonite::EC2
  class GetManagedPrefixListEntriesRequest
    ...
    # The version of the prefix list for which to return the entries. The default is the current
    # version.
    property target_version : Int64 | Nil
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      if value = @target_version
        params << {"#{prefix}TargetVersion", value.to_s}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        target_version: Core::XMLValue.i64(node.xpath_node("*[local-name()='TargetVersion']")),
    ...
    def_equals_and_hash(@dry_run, @prefix_list_id, @target_version, @max_results, @next_token)
  end
end
