...
module Amazonite::EC2
  class DescribeVpcClassicLinkDnsSupportRequest
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        vpc_ids: node.xpath_nodes("*[local-name()='VpcIds']/*[local-name()='VpcId']").map { |n| n.content },
    ...
    def_equals_and_hash(@vpc_ids, @max_results, @next_token)
  end
end
