...
module Amazonite::EC2
  ...
  class LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest
    ...
    property private_ip_addresses : Array(SecondaryInterfacePrivateIpAddressSpecificationRequest) | Nil
    ...
    def initialize(
      ...
      @private_ip_addresses : Array(SecondaryInterfacePrivateIpAddressSpecificationRequest) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@private_ip_addresses || [] of SecondaryInterfacePrivateIpAddressSpecificationRequest).each_with_index(1) do |item, i|
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        private_ip_addresses: node.xpath_nodes("*[local-name()='PrivateIpAddress']/*[local-name()='SecondaryInterfacePrivateIpAddressSpecification']").map { |n| SecondaryInterfacePrivateIpAddressSpecificationRequest.from_xml(n) },
