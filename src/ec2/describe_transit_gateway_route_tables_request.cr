...
module Amazonite::EC2
  class DescribeTransitGatewayRouteTablesRequest
    ...
    property transit_gateway_route_table_ids : Array(String) | Nil
    ...
    def initialize(
      @transit_gateway_route_table_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@transit_gateway_route_table_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}TransitGatewayRouteTableIds.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        transit_gateway_route_table_ids: node.xpath_nodes("*[local-name()='TransitGatewayRouteTableIds']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@transit_gateway_route_table_ids, @filters, @max_results, @next_token, @dry_run)
  end
end
