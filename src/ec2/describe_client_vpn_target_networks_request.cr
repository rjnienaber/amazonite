  ...
  class DescribeClientVpnTargetNetworksRequest
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@association_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}AssociationIds.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        association_ids: node.xpath_nodes("*[local-name()='AssociationIds']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@client_vpn_endpoint_id, @association_ids, @max_results, @next_token, @filters, @dry_run)
  end
end
