...
module Amazonite::EC2
  class DescribeLocalGatewayRouteTablesRequest
    ...
    property local_gateway_route_table_ids : Array(String) | Nil
    ...
    def initialize(
      @local_gateway_route_table_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@local_gateway_route_table_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}LocalGatewayRouteTableId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        local_gateway_route_table_ids: node.xpath_nodes("*[local-name()='LocalGatewayRouteTableId']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@local_gateway_route_table_ids, @filters, @max_results, @next_token, @dry_run)
  end
end
