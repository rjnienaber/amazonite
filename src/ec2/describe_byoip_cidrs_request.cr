...
module Amazonite::EC2
  class DescribeByoipCidrsRequest
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      params << {"#{prefix}MaxResults", @max_results.to_s}
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        max_results: Core::XMLValue.i32(node.xpath_node("*[local-name()='MaxResults']")).not_nil!,
    ...
    def_equals_and_hash(@dry_run, @max_results, @next_token)
  end
end
