...
module Amazonite::EC2
  ...
  # `capacityReservationPreference` response element if the instance is configured to run in
  # On-Demand capacity, or if it is configured in run in any `open` Capacity Reservation that has
  # matching attributes (instance type, platform, Availability Zone). The action returns the
  # `capacityReservationTarget` response element if the instance explicily targets a specific
  # Capacity Reservation or Capacity Reservation group.
