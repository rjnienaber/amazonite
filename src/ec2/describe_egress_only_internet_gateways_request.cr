...
module Amazonite::EC2
  class DescribeEgressOnlyInternetGatewaysRequest
    ...
    property egress_only_internet_gateway_ids : Array(String) | Nil
    ...
    def initialize(
      ...
      @egress_only_internet_gateway_ids : Array(String) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@egress_only_internet_gateway_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}EgressOnlyInternetGatewayId.#{i}", item}
      end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        egress_only_internet_gateway_ids: node.xpath_nodes("*[local-name()='EgressOnlyInternetGatewayId']/*[local-name()='item']").map { |n| n.content },
    ...
    def_equals_and_hash(@dry_run, @egress_only_internet_gateway_ids, @max_results, @next_token, @filters)
  end
end
