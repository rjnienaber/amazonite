...
module Amazonite::EC2
  class GetTransitGatewayPrefixListReferencesRequest
    ...
    #
    # - `attachment.resource-type` - The type of resource for the attachment. Valid values are `vpc` |
    ...
    def_equals_and_hash(@transit_gateway_route_table_id, @filters, @max_results, @next_token, @dry_run)
  end
end
