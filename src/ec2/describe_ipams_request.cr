...
module Amazonite::EC2
  class DescribeIpamsRequest
    ...
    property ipam_ids : Array(String) | Nil
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@ipam_ids || [] of String).each_with_index(1) do |item, i|
        params << {"#{prefix}IpamId.#{i}", item}
      end
      params
    end
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        ...
        ipam_ids: node.xpath_nodes("*[local-name()='IpamId']/*[local-name()='item']").map { |n| n.content },
      )
    end
    ...
    def_equals_and_hash(@dry_run, @filters, @max_results, @next_token, @ipam_ids)
  end
end
