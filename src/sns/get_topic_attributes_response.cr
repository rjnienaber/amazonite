module Amazonite::Sns
  ...
  class GetTopicAttributesResponse
    ...
    # and `email-json` endpoints. For subscription confirmation and unsubscribe confirmation emails,
    # the sender name is always "Amazon Web Services Notifications" regardless of this attribute.
    #
    ...
    # topic. Amazon SNS returns this attribute only if you explicitly set it. If Amazon SNS doesn't
