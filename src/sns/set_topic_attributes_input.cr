...
module Amazonite::Sns
  ...
  class SetTopicAttributesInput
    ...
    #
    # You can increase or decrease this value at any time. If the topic doesn't meet these
    # requirements when you set a value above 256 KiB, Amazon SNS returns an `InvalidParameter` error.
