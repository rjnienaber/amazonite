module Amazonite::SqsV1
  ...
  class SendMessageBatchRequestEntry
    ...
    # The message system attribute to send Each message system attribute consists of a `Name`, `Type`,
    # and `Value`.
    #
    ...
    # messages with the same `MessageDeduplicationId` are accepted successfully but aren't delivered.
