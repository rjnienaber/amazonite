...
module Amazonite::CloudFormation
  class ListStackSetsOutput
    ...
    def initialize(
      @summaries : Array(StackSetSummary) | Nil = nil,
    ...
    def to_query_params(prefix : String) : Array({String, String})
      ...
      (@summaries || [] of StackSetSummary).each_with_index(1) do |item, i|
    ...
    def self.from_xml(node : XML::Node) : self
      new(
        summaries: node.xpath_nodes("*[local-name()='Summaries']/*[local-name()='member']").map { |n| StackSetSummary.from_xml(n) },
