module Amazonite::KmsV1
  class DescribeKeyRequest
    ...
    #
    # If you specify a predefined Amazon Web Services alias (an Amazon Web Services alias with no key
    # ID), KMS associates the alias with an [Amazon Web Services managed
    # key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-key) and
